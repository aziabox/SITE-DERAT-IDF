...
const og = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    ...
    <style>
      ...
      .lbl { font-size: 22px; font-weight: 700; letter-spacing: 3.4px; fill: #e8a98a; }
      .h { font-size: 68px; font-weight: 800; letter-spacing: -2px; }
      .s { font-size: 28px; font-weight: 500; fill: #a7bcb3; }
      .tel { font-size: 38px; font-weight: 800; fill: #e8a98a; letter-spacing: -1px; }
    </style>
  </defs>
  <rect width="1200" height="630" fill="#12302a"/>
  <rect width="1200" height="630" fill="url(#g)"/>
  <rect x="0" y="0" width="1200" height="6" fill="#b0542c"/>
  <g transform="translate(80,92)">
    <path d="M0 96V38L32 20l32 18v58" fill="none" stroke="#ffffff" stroke-width="7" stroke-linejoin="round"/>
    <rect x="22" y="62" width="20" height="34" fill="#e8a98a"/>
  </g>
